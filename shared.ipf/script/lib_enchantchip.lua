...
function IS_ENCHANT_ITEM(item)
	if item.ClassName == "Premium_Enchantchip" or item.ClassName == "Premium_Enchantchip14" or item.ClassName == "Premium_Enchantchip_CT" or
	   ...
	   or item.ClassName == "Event_Enchantchip_200" or item.ClassName == "Event_Enchantchip_201" or item.ClassName == "Event_Enchantchip_8" 
           ...
           or item.ClassName == "Event_Enchantchip_16" or item.ClassName == "Event_Enchantchip_17" or item.ClassName == "Event_Enchantchip_18" or item.ClassName == "Event_Enchantchip_205" or item.ClassName == "Event_Enchantchip_25" or item.ClassName == "Event_Enchantchip_206" or item.ClassName == "Event_Enchantchip_33" then
		return 1;
	end
